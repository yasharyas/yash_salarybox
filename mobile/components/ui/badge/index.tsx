...
// nativewind v5 narrows styled()'s second argument to undefined for this
// component shape, so the config upstream ships does not typecheck even
// though it is correct at runtime. Cast at the boundary rather than delete a
// working style mapping.
const StyledUIIcon = styled(UIIcon, {
  className: {
    target: 'style',
    // @ts-expect-error nativewind v5 narrows this to undefined; the mapping
    // upstream ships is correct at runtime.
    nativeStyleToProp: {
      height: true,
      width: true,
      fill: true,
