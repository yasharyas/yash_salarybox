...
>(function AlertDialogContent({ className, size, ...props }, ref) {
  ...
  return (
    <UIAccessibleAlertDialog.Content
      pointerEvents="auto"
      // Upstream (gluestack v5 alpha) also passed opacity here, which the
      // typed withInitialValues signature does not accept. ZoomIn already
      // fades in, so dropping it costs nothing visible.
